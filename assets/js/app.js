...
function renderDoc() {
  return `
    ...
    <div class="card" style="max-width:720px;line-height:1.8;">
      ...
      <p style="margin-bottom:var(--s-4);">Je ne suis pas développeur au sens où on l'entend. Je n'ai pas de diplôme, pas de titre, pas de bureau dans la Silicon Valley. Je suis quelqu'un qui [...]
      <p style="margin-bottom:var(--s-4);">Ce projet n'attaque aucune IA. Il ne contourne aucune règle. Il ne cherche pas à manipuler, à tromper, à nuire. Il fait une seule chose : <strong>do[...]
      <p style="margin-bottom:var(--s-4);">Un prompt bien écrit est un pont entre une idée et un résultat. Pour beaucoup, ce pont est invisible, technique, réservé. Je veux le rendre visible[...]
